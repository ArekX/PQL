...
class PgsqlDriverTest extends PgsqlTestCase
{
    ...
    public function testPdoInstanceCreation()
    {
        ...
        // With emulated prepares PostgreSQL returns integer columns as strings.
    ...
    {
        $query = select(raw('COUNT(*)::int'))->from('users');
    ...
    public function testGetLastInsertedId()
    {
        ...
        // PostgreSQL needs the sequence name to resolve the last inserted id.
        $lastInserted = $driver->getLastInsertedId('users_id_seq');
