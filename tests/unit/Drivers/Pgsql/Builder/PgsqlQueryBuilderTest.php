...
namespace unit\Drivers\Pgsql\Builder;
...
class PgsqlQueryBuilderTest extends \Codeception\Test\Unit
{
    public function testGettingABuilder()
    {
        $s = new PgsqlQueryBuilder();
    ...
    public function testCreateState()
    {
        ...
        $s = $this->make(PgsqlQueryBuilder::class, [
    ...
    public function testStateIsConfiguredForPostgresDialect()
    {
        $state = (new PgsqlQueryBuilder())->createState();
