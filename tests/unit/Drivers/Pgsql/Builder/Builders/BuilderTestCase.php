...
{
    protected function assertQueryResults(array $queries, ?PgsqlQueryBuilder $state = null)
    {
    ...
    protected function build(StructuredQuery $query, ?PgsqlQueryBuilder $state = null)
    {
