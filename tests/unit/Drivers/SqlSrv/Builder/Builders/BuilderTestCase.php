...
{
    protected function assertQueryResults(array $queries, ?SqlSrvQueryBuilder $state = null)
    {
    ...
    protected function build(StructuredQuery $query, ?SqlSrvQueryBuilder $state = null)
    {
