...
use ArekX\PQL\Drivers\Pdo\Common\Builders\Traits\ValueColumnTrait;
...
class CallBuilder extends QueryPartBuilder
{
    ...
    {
        return [
            'name' => fn($name, CommonQueryBuilderState $state) => $this->buildNamePart($name, $state),
            'params' => fn($params, CommonQueryBuilderState $state) => ['', $this->buildParamsPart($params, $state)],
        ];
    }
     ...
     * @param CommonQueryBuilderState $state Current query builder state.
     * @return string
     */
    protected function buildNamePart(StructuredQuery|string $name, CommonQueryBuilderState $state): StructuredQuery|string
    {
     ...
     * @throws \Exception
     */
    protected function buildParamsPart(array $params, CommonQueryBuilderState $state): string
    {
        $result = [];
