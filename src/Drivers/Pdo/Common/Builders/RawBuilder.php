...
class RawBuilder extends QueryPartBuilder
{
    ...
    protected function getPartBuilders(): array
    {
        return [
            'query' => fn($part) => $part,
            'params' => fn($part, CommonQueryBuilderState $state) => $this->mergeParams($part, $state)
        ];
    }
     ...
     */
    protected function mergeParams(array $params, CommonQueryBuilderState $state): null
    {
