...
class InsertBuilder extends QueryPartBuilder
{
    ...
    protected function buildInto($part, $state)
    {
        ...
        return 'INTO ' . $this->quoteName($part, $state);
    }
     ...
     * @return string
     */
    protected function buildColumns(StructuredQuery|array $columns, CommonQueryBuilderState $state): string
    {
        ...
        foreach ($columns as $column) {
            $result[] = $this->quoteName($column, $state);
        }
     ...
     * @return string
     */
    protected function buildValueItems(array $valuesList, CommonQueryBuilderState $state): string
    {
        $results = [];
     ...
     * @return string
     */
    protected function buildValues(StructuredQuery|array $values, CommonQueryBuilderState $state): string
    {
