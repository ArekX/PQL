...
trait ConditionTrait
{
     ...
     */
    protected function buildCondition(StructuredQuery|array $condition, CommonQueryBuilderState $state): string
    {
        static $map = null;
        ...
        if ($map === null) {
            $map = [
                ...
                '<>' => fn($condition, $state) => $this->buildBinaryCondition(' <> ', $condition, $state),
                '!=' => fn($condition, $state) => $this->buildBinaryCondition(' <> ', $condition, $state),
                'column' => fn($condition, $state) => $this->buildColumnCondition($condition, $state),
     ...
     * @return string
     */
    protected function buildAssociativeCondition(string $glue, array $condition, CommonQueryBuilderState $state): string
    {
        $result = [];
        foreach ($condition[1] as $key => $value) {
            $leftSide = $this->quoteName($key, $state);
     ...
     * @throws Exception
     */
    protected function buildConjunctionCondition(string $glue, array $condition, CommonQueryBuilderState $state): string
    {
        $result = [];
     ...
     * @throws Exception
     */
    protected function buildUnaryCondition(string $op, array $condition, CommonQueryBuilderState $state): string
    {
     ...
     * @throws Exception
     */
    protected function buildInCondition(array $condition, CommonQueryBuilderState $state): string
    {
     ...
     * @throws Exception
     */
    protected function buildBetweenCondition(array $condition, CommonQueryBuilderState $state): string
    {
     ...
     * @throws Exception
     */
    protected function buildBinaryCondition(string $operation, array $condition, CommonQueryBuilderState $state): string
    {
        $left = $this->buildCondition($condition[1] ?? null, $state);
     ...
     * @return string
     */
    protected function buildColumnCondition(array $condition, CommonQueryBuilderState $state): string
    {
        ...
        return $this->quoteName($column, $state);
    }
     ...
     * @return string
     */
    protected function buildValueCondition(array $condition, CommonQueryBuilderState $state): string
    {
